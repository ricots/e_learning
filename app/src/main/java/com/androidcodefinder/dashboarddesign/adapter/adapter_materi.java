 ...
 */
public class adapter_materi extends RecyclerView.Adapter<adapter_materi.Holder> {

    private static final String TAG = adapter_materi.class.getSimpleName();
    ...
    public adapter_materi(data_kirim listener) {
        mtr = new ArrayList<>();
        mListen = listener;
    }
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_materi, parent, false);
